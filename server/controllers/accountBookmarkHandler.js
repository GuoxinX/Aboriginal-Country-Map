...
var getUserBookmarks = function(req, res) {
  /*req.body = {
      ...
      if (genFuncs.isValidUserToken(req.body.id, token, res)) {
        Account.findOne({ _id: req.body.id })
          ...
          .then(function(user) {
            ...
            bookmarks.forEach(function(plotid) {
      ...
      if (genFuncs.isValidUserToken(req.body.id, token, res)) {
        Account.findOne({ _id: req.body.id })
          ...
          .then(function(user) {
            var newDetails = {};
            if (req.body.plotID) {
              newDetails.bookmarks = req.body.plotID;
            }
        ...
        Account.findOne({ _id: req.body.id })
          ...
          .then(function(user) {
            ...
            Account.findByIdAndUpdate(req.body.id, {
              $pull: { bookmarks: req.body.plotID }
            })
              .exec()
              .then(function() {
                genFuncs.successNoData(res);
...
module.exports.getUserBookmarks = getUserBookmarks;
